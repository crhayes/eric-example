var App = (function() {
  ...
  App.prototype.init = function() {
    this.fetchTracks('rock').then(tracks => {
      this.render(tracks);
    });
  }

  App.prototype.onGenreChange = function(event) {
    this.fetchTracks(event.value).then(tracks => {
      this.render(tracks);
    });
  }

  App.prototype.fetchTracks = function(genreSlug) {
